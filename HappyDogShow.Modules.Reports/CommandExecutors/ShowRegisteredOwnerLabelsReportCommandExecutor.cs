...
{
    class ShowRegisteredOwnerLabelsReportCommandExecutor
    {
        ...
        public ShowRegisteredOwnerLabelsReportCommandExecutor(IReportViewerService reportViewerService, IBreedEntryService breedEntryService)
        {
            ...
            DogShowReportCommands.ShowRegisteredOwnerLabelsReportCommand.RegisterCommand(commandHandler);
        }
        ...
        private async void ExecuteCommand(IDogShowEntity obj)
        {
            ...
            _reportViewerService.ShowReport(@"Reports\RegisteredOwnerLabelsForShow.rdlc", datasources, parms);
        }
    }
}
